...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
  ...
  fn update_protocol_fee() -> Weight {
	Weight::from_parts(217_917_000 as u64, 0).saturating_add(T::DbWeight::get().writes(1 as u64))
  }
...
impl WeightInfo for () {
	...
	// Storage: AMM ProtocolFee (r:0 w:1)
	fn update_protocol_fee() -> Weight {
		Weight::from_parts(217_917_000 as u64, 0).saturating_add(RocksDbWeight::get().writes(1 as u64))
	}
	// Storage: AMM ProtocolFeeReceiver (r:0 w:1)
	fn update_protocol_fee_receiver() -> Weight {
		Weight::from_parts(217_917_000 as u64, 0).saturating_add(RocksDbWeight::get().writes(1 as u64))
